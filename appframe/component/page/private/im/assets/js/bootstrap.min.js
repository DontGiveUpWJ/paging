...
b(window).on("load",function(){b(".swiper-container").each(function(){var c=b(this);a.call(c);});});b(function(){if(b(".swiper-carousel").length>0){var c=new Swiper(".swiper-carousel",{pagination:".swiper-pagination",paginationClickable:true,autoplay:5000,autoplayDisableOnInteraction:false});
}});}(jQuery);